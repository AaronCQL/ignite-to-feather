...
type App struct {
	*baseapp.BaseApp
	...
	PlutoKeeper plutomodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.PlutoKeeper = *plutomodulekeeper.NewKeeper(
		appCodec,
		keys[plutomoduletypes.StoreKey],
		keys[plutomoduletypes.MemStoreKey],
		app.GetSubspace(plutomoduletypes.ModuleName),
	)
	plutoModule := plutomodule.NewAppModule(appCodec, app.PlutoKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(plutomoduletypes.ModuleName)
